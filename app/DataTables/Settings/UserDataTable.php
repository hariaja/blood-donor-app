...
class UserDataTable extends DataTable
{
  ...
  public function dataTable(QueryBuilder $query): EloquentDataTable
  {
    return (new EloquentDataTable($query))
      ...
      ->addColumn('roles', function ($row) {
        ...
        elseif ($row->isRoleName() === Constant::OFFICER) :
          return '<span class="badge text-primary">' . Constant::OFFICER . '</span>';
        else :
          return '<span class="badge text-warning">' . Constant::DONOR . '</span>';
        endif;
      })
  ...
  {
    return $this->userService->excludeAdmin();
  }
